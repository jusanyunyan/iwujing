...
class Gd{
	 ...
	 * @param  integer $paddingRight   距离右侧的距离（仅对右下角管用：2014-04-21 侯胜利添加）
     * @param  integer $paddingBottom  距离底侧的距离（仅对右下角管用：2014-04-21 侯胜利添加）
     */
    public function water($source, $locate = Image::IMAGE_WATER_SOUTHEAST,$alpha=80,$paddingRight=18,$paddingBottom=18){
        //资源检测
        ...
        switch ($locate) {
            ...
            case Image::IMAGE_WATER_SOUTHEAST:
                $x = $this->info['width'] - $info[0]-$paddingRight;
                $y = $this->info['height'] - $info[1]-$paddingBottom;
				break;
